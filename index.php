					...
					<div class="table-struct full-width full-height">
						<div class="table-cell vertical-align-middle auth-form-wrap">
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row login-panel-body">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in to UPJJMMS</h3>
											<h6 class="text-center nonecase-font txt-grey">Enter your details below</h6>
										</div>	
										<div class="form-wrap">
											<form action="staff_login_code.php" method="post">
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputEmail_2">Email address</label>
													<input type="email" class="form-control" required="" name="username" id="username" placeholder="Enter email">
												</div>
												<div class="form-group">
													...
													<?php
															...
															$_SESSION['tokenp'] = $myToken;
													?>
													<input type="hidden" name="tokenp" value="<?= $_SESSION['tokenp']; ?>">
												</div>
